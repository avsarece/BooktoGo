...
if st.button("Show Recommend"):
    book_name1 = rs.find_most_similar(selected_book)[0]
    book_name2 = rs.find_most_similar(selected_book)[1]
    book_name3 = rs.find_most_similar(selected_book)[2]
